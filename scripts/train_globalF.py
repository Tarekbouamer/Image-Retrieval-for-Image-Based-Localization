...
# dataset
from cirtorch.datasets.globalFeatures import TuplesDataset, NETWORK_INPUTS, TuplesTransform, \
    TuplesDistributedARBatchSampler, iss_collate_fn, ParisOxfordTestDataset

# generic data
from cirtorch.datasets.generic import ISSDataset, ISSTestTransform, DistributedARBatchSampler, INPUTS
...
from cirtorch.modules.heads.global_head import globalHead

# algos
from cirtorch.algos.GF_algo import globalFeatureAlgo, globalFeatureLoss

# models
from cirtorch.models.GF_net import ImageRetrievalNet
...
def make_dir(config, directory):
    ...
    extension += "_{}_{}".format(config["global"].getstruct("pooling")["name"],
                                 config["global"].getstruct("normal")["name"])
